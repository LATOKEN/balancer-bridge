...
// AdminSetExpiry is a paid mutator transaction binding the contract method 0xc9ae58f5.
//
// Solidity: function adminSetExpiry(uint256 newExpiry) returns()
func (_LaBr *LaBrTransactor) AdminSetExpiry(opts *bind.TransactOpts, newExpiry *big.Int) (*types.Transaction, error) {
	return _LaBr.contract.Transact(opts, "adminSetExpiry", newExpiry)
}

// AdminSetExpiry is a paid mutator transaction binding the contract method 0xc9ae58f5.
//
// Solidity: function adminSetExpiry(uint256 newExpiry) returns()
func (_LaBr *LaBrSession) AdminSetExpiry(newExpiry *big.Int) (*types.Transaction, error) {
	return _LaBr.Contract.AdminSetExpiry(&_LaBr.TransactOpts, newExpiry)
}

// AdminSetExpiry is a paid mutator transaction binding the contract method 0xc9ae58f5.
//
// Solidity: function adminSetExpiry(uint256 newExpiry) returns()
func (_LaBr *LaBrTransactorSession) AdminSetExpiry(newExpiry *big.Int) (*types.Transaction, error) {
	return _LaBr.Contract.AdminSetExpiry(&_LaBr.TransactOpts, newExpiry)
}
